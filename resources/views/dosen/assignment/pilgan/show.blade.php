      ...
      <div class="col-6">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h3 class="text-center">Detail {{$assignment->judul}}</h3>
          </div>
          <div class="row px-xl-5 px-sm-4 px-3">
            ...
            <div class="card-body">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="judul" placeholder="Judul" value="{{$assignment->judul}}" readonly>
              </div>
              <div class="mb-3">
              ...
              <div class="card-body tab-pane fade show position-relative active  border-radius-lg" id="cam1" role="tabpanel" aria-labelledby="cam1">
                <form role="form text-left" action="{{route('soalPilgan')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                    ...
                    <input name="kelas_id" value="{{$assignment->kelas_id}}" type="hidden" required>
                    <input name="assignment_pilgan_id" type="hidden" value="{{$assignment->id}}" required>
                  </div>
