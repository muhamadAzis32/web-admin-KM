        ...
        <div class="col-lg-9 col-12 mx-auto">
          <div class="card card-body mt-4">
            ...
            <div class="text-start">
                <a href="#" class="btn btn-outline-info">Download Format Excel</a>          
            </div>
            <div class="card-body">
              <form role="form text-left" action="{{route('AssignmentPilgan.store')}}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlSelect1">Import Soal</label>
                    <input type="file" class="form-control" name="file" required>
                  </div>
                <div class="mb-3">
                    <label for="exampleFormControlSelect1">Deadline</label>
                    <input class="form-control datepicker" name="deadline" placeholder="Please select date" type="text" onfocus="focused(this)" onfocusout="defocused(this)">
                </div>
                {{-- <div class="mb-3">
