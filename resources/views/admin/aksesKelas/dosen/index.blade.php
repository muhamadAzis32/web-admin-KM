            ...
            <div class="card-header pb-0 p-3">
                <div class="row">
                    <div class="col-6 d-flex align-items-center">
                        <h6 class="mb-0">Data Hak Akses Kelas Dosen</h6>
                    </div>
                    <div class="col-6 text-end">
                        <a class="btn bg-gradient-dark mb-0" href="{{ route('akseskelasDosen.create') }}"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="ms-auto text-center">
                                        <form action="{{ route('destroyAksesKelasDosen', $item->id) }}" method="POST"
                                        ...
                                        <a class="btn btn-link text-dark px-3 mb-0"
                                            href="{{ route('editAksesKelasDosen', $item->id) }}"><i
                                                class="fas fa-user-edit text-secondary"></i></a>
                                        {{-- <a class="btn btn-link text-dark px-3 mb-0" href="{{route('aksesKelasDosen.show', $item->id)}}"><i class="fas fa-eye text-secondary"></i></a> --}}
                                    </div>
                                </td>
                            </tr>
                        @endforeach
