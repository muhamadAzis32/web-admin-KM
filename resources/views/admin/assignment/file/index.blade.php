        ...
        <div class="card-header pb-0 p-3">
          <div class="row">
            <div class="col-6 d-flex align-items-center">
              <h6 class="mb-0">Data Assignment File</h6>
            </div>
              ...
              <tr>
                ...
                <td>
                  <div class="ms-auto text-center">
                    <form action="{{route('destroyAssignmentFile', $item->id)}}" style="display: inline">
                      @csrf
                    ...
                    <a class="btn btn-link text-dark px-3 mb-0" href="{{route('editAssignmentFile', $item->id)}}"><i class="fas fa-user-edit text-secondary"></i></a>
