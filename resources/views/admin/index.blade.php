<x-app-layout>
        ...
        <div class="row">
          <div class="col-3 py-3 ps-0">
            <div class="d-flex mb-2">
              ...
              <p class="text-xs mt-1 mb-0 font-weight-bold">Mahasiswa Lulus</p>
            </div>
            <h4 class="font-weight-bolder">{{$mahasiswa_lulus}}</h4>
          ...
          <div class="col-3 py-3 ps-0">
            <div class="d-flex mb-2">
              ...
              <p class="text-xs mt-1 mb-0 font-weight-bold">Mahasiswa Tidak Lulus</p>
            </div>
            <h4 class="font-weight-bolder">{{$mahasiswa_belum_lulus}}</h4>
            <div class="progress w-75">
              <div class="progress-bar bg-dark w-100" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
          <div class="col-3 py-3 ps-0">
            <div class="d-flex mb-2">
              ...
              <p class="text-xs mt-1 mb-0 font-weight-bold">Materi Selesai Diakses</p>
            </div>
            <h4 class="font-weight-bolder">{{$materi_selesai}}</h4>
            <div class="progress w-75">
              <div class="progress-bar bg-dark w-100" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
          <div class="col-3 py-3 ps-0">
            <div class="d-flex mb-2">
              ...
              <p class="text-xs mt-1 mb-0 font-weight-bold">Pertemuan Terselesaikan</p>
            </div>
            <h4 class="font-weight-bolder">{{$pertemuan_selesai}}</h4>
            <div class="progress w-75">
              <div class="progress-bar bg-dark w-100" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Total Mahasiswa Setiap Mata Kuliah</h6>
              </div>
            </div>
            <div class="table-responsive">
              <table class="table align-items-center ">
                <tbody>
                  @foreach($enroll_jumlah as $p)
                  <tr>
                    <td class="w-30">
                      <div class="d-flex px-2 py-1 align-items-center">
                        ...
                        <div class="ms-4">
                          ...
                          <h6 class="text-sm mb-0">{{$p->judul}}</h6>
                        </div>
                      </div>
                    </td>
                    <td>
                      <div class="text-center">
                        <p class="text-xs font-weight-bold mb-0">Jumlah Mahasiswa:</p>
                        <h6 class="text-sm mb-0">{{count($p->enroll);
                        }}</h6>
                      </div>
                    </td>
                    {{-- <td>
  ...
  <script>
    var typed = new Typed("#typed", {
      strings: ["Datang di Dashboard Admin!"],
      typeSpeed: 40,
      startDelay: 90,
      loop: true
    });
