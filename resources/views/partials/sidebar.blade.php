...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="/" target="_blank">
      <img src="{{asset('assets/foto/kg/logo.png')}}" class="navbar-brand-img h-100" alt="main_logo">
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{Route::is('administrasi.*') ? 'active' : ''}} " href="{{route('administrasi.index')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link {{Route::is('kategori.*') ? 'active' : ''}} " href="{{route('kategori.index')}}">
          ...
          <span class="nav-link-text ms-1">Skill Level</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link {{Route::is('kelas.*') ? 'active' : ''}} " href="{{route('kelas.index')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#konten" class="nav-link {{Route::is('konten*') ? 'active' : ''}}" aria-controls="konten" role="button" aria-expanded="false">
        ...
        <div class="collapse   {{Route::is('konten*') ? 'show' : ''}}" id="konten">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item {{Route::is('kontenVideo.*') ? 'active' : ''}}">
              <a class="nav-link {{Route::is('kontenVideo.*') ? 'active' : ''}}" href="{{route('kontenVideo.index')}}">
                <span class="sidenav-mini-icon"> K </span>
                <span class="sidenav-normal"> Konten Video </span>
              </a>
            </li>
          </ul>
          <ul class="nav ms-4 ps-3">
            <li class="nav-item {{Route::is('kontenDokumen.*') ? 'active' : ''}}">
              <a class="nav-link {{Route::is('kontenDokumen.*') ? 'active' : ''}}" href="{{route('kontenDokumen.index')}}">
                <span class="sidenav-mini-icon"> K </span>
                <span class="sidenav-normal"> Konten Dokumen </span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{Route::is('iklan.*') ? 'active' : ''}} " href="{{route('iklan.index')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>credit-card</title>
              <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item">
        <a class="nav-link {{Route::is('artikel.*') ? 'active' : ''}} " href="{{route('artikel.index')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>credit-card</title>
              <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item">
        <a class="nav-link {{Route::is('profil.*') ? 'active' : ''}} " href="{{route('profil.index')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      {{-- asdas  --}}
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#dosen" class="nav-link {{Route::is('akseskelasDosen*','||','dataDosen*') ? 'active' : ''}}" aria-controls="dosen" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
            <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>customer-support</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="collapse   {{Route::is('dataDosen*','||','akseskelasDosen*') ? 'show' : ''}}" id="dosen">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item {{Route::is('dataDosen*') ? 'active' : ''}}">
              <a class="nav-link {{Route::is('dataDosen*') ? 'active' : ''}}" href="{{url('dataDosen')}}">
                <span class="sidenav-mini-icon"> Data Dosen </span>
                <span class="sidenav-normal"> Data Dosen </span>
              </a>
            </li>
          </ul>
          <ul class="nav ms-4 ps-3">
            <li class="nav-item {{Route::is('akseskelasDosen*') ? 'active' : ''}}">
              <a class="nav-link {{Route::is('akseskelasDosen*') ? 'active' : ''}}" href="{{route('akseskelasDosen.index')}}">
                <span class="sidenav-mini-icon"> Hak Akses Kelas </span>
                <span class="sidenav-normal"> Hak Akses Kelas </span>
              </a>
            </li>
          </ul>
        </div>
      ...
      {{-- asdasd --}}
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#mahasiswa" class="nav-link {{Route::is('akseskelasMahasiswa*','||','dataMahasiswa*') ? 'active' : ''}}" aria-controls="mahasiswa" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
            <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>customer-support</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="collapse   {{Route::is('dataMahasiswa*','||','akseskelasMahasiswa*') ? 'show' : ''}}" id="mahasiswa">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item {{Route::is('dataMahasiswa*') ? 'active' : ''}}">
              <a class="nav-link {{Route::is('dataMahasiswa*') ? 'active' : ''}}" href="{{route('dataMahasiswa')}}">
                <span class="sidenav-mini-icon"> Data Mahasiswa </span>
                <span class="sidenav-normal"> Data Mahasiswa </span>
              </a>
            </li>
          </ul>
          <ul class="nav ms-4 ps-3">
            <li class="nav-item {{Route::is('akseskelasMahasiswa*') ? 'active' : ''}}">
              <a class="nav-link {{Route::is('akseskelasMahasiswa*') ? 'active' : ''}}" href="{{route('akseskelasMahasiswa.index')}}">
                <span class="sidenav-mini-icon"> Hak Akses Kelas </span>
                <span class="sidenav-normal"> Hak Akses Kelas </span>
              </a>
            </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{Route::is('jobChannel.*') ? 'active' : ''}} " href="{{route('jobChannel.index')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Job Channel</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{Route::is('guide.*') ? 'active' : ''}} " href="{{route('guide.index')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>spaceship</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">E-Guide</span>
        </a>
      </li>
      {{-- <li class="nav-item">
        <a class="nav-link {{Route::is('assignment.*') ? 'active' : ''}} " href="{{route('assignment.index')}}">
      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        <svg class="text-dark" width="16px" height="16px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <title>office</title>
          <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Kelas</h6>
      </li>

      @foreach ($AksesKelas->where('user_id',Auth::user()->id) as $item)
      {{-- <li class="nav-item">
        <a class="nav-link {{Route::is('matkul.*') ? 'active' : ''}} " href="{{route('mataKuliah.show', $item->id)}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">{{$item->matkul->judul}}</span>
        </a>
      </li> --}}
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#matkul-{{ $item->id }}" class="nav-link {{Route::is('matkul.*') ? 'active' : ''}}" aria-controls="matkul" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
        ...
        <div class="collapse   {{Route::is('matkul*') ? 'show' : ''}}" id="matkul-{{ $item->id }}">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item {{Route::is('matkul.*') ? 'active' : ''}}">
              <a class="nav-link {{Route::is('matkul.*') ? 'active' : ''}}" href="{{route('mataKuliah.show', $item->id)}}">
                <span class="sidenav-normal"> Detail Mata Kuliah </span>
              </a>
            </li>
          </ul>
          <ul class="nav ms-4 ps-3">
      ...
      <li class="nav-item">
        <a class="nav-link  {{request()->is('discussion-forum') ? 'active' : ''}} " href="{{route('discussion-forum')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
